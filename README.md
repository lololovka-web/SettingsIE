...
Requirements
Windows 10 / 11
.NET 8+ (builds from source)
Administrator rights recommended for full registry access
Usage
GUI
dotnet run
Select categories on the Export tab, choose a destination path and click Export. On the Import tab, load a JSON file, select categories and click Import.
